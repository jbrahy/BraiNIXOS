...
const fn build_address_tag_bytes() -> [u8; 24] {
    ...
    [
        ...
        0,
        0,
        header_address_bytes[0],
        header_address_bytes[1],
        header_address_bytes[2],
        header_address_bytes[3],
        load_begin_address_bytes[0],
        load_begin_address_bytes[1],
        load_begin_address_bytes[2],
        load_begin_address_bytes[3],
        load_end_address_bytes[0],
        load_end_address_bytes[1],
        load_end_address_bytes[2],
        load_end_address_bytes[3],
        bss_end_address_bytes[0],
        bss_end_address_bytes[1],
        bss_end_address_bytes[2],
        bss_end_address_bytes[3],
    ]
}
...
const fn build_entry_address_tag_bytes() -> [u8; 16] {
    ...
    [
        ...
        0,
        0,
        entry_address_bytes[0],
        entry_address_bytes[1],
        entry_address_bytes[2],
        entry_address_bytes[3],
        0,
        0,
        0,
        0,
...
const fn concatenate_header_sections(
    ...
    [
        ...
        entry_address_tag[8],
        entry_address_tag[9],
        entry_address_tag[10],
        entry_address_tag[11],
        entry_address_tag[12],
        entry_address_tag[13],
        entry_address_tag[14],
        entry_address_tag[15],
        end_tag[0],
        end_tag[1],
        end_tag[2],
        end_tag[3],
